...
Далі, коли ми будемо розгортати наш додаток, ми виконаємо схожий процес (дивіться розділ :ref:`Розгортання вашого додатку <virtual-environment>`_) та налаштуємо віртуальне оточення на PythonAnywhere.

Репозиторій коду
****************
Ми повинні також зауважити, що при розробці коду вам слід зберігати свій код за допомогою системи контролю версій на зразок `SVN <http://subversion.tigris.org/>`_ або `GIT <http://git-scm.com/>`_. Зараз ми не будемо розгядати це питання, однак надамо посилання :ref:`crash course on GIT <git-crash-course>`_. Ми настійно радимо налаштувати репозиторій GIT для ваших проектів. Це може врятувати вас від катастрофи.
