...
У цій версії онлайн підручника(книги), оновлено та додано кілька речей:
...
* Додано новий розділ про автентифікацію
    ...
    * Логін і реєстрація зроблено за допомогою Django-Registration-Redux (див. розділ :ref:`login-redux-label`)
