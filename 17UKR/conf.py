# -*- coding: utf-8 -*-
#
# How_To_Tango_With_Django documentation build configuration file, created by
...
project = u'How To Tango With Django 1.7'
...
html_title = 'How to Tango with Django 1.7'
...
htmlhelp_basename = 'How_To_Tango_With_Djangodoc'
...
latex_documents = [
  ('index', 'How_To_Tango_With_Django.tex', u'How to Tango with Django 1.7',
...
man_pages = [
    ('index', 'how to tango with django 1.7', u'How To Tango With Django 1.7',
...
texinfo_documents = [
  ('index', 'How To Tango With Django 1.7', u'How To Tango With Django 1.7',
   u'Leif Azzopardi and David Maxwell', 'How To Tango With Django 1.7', 'A starters Guide to Web Development in Django 1.7',
   'Miscellaneous'),
]
...
epub_title = u'How To Tango With Django 1.7'
